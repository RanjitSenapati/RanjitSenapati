...
**Stack:** Python · OpenCV · Pandas · Jupyter Notebook · Matplotlib
...
> **One-time setup required** — this image stays blank until you activate it on your own account (GitHub Actions has to generate it from your real contribution graph; it can't be pre-rendered from here). Full copy-paste steps are below.
